               ...
               <div class='overflow-x-auto mt-4'>
                  <table class='divide-y-1 text-base divide-gray-600 w-full'>
                     ...
                     <tbody class='divide-y divide-slate-600/50'>
                        ...
                        <tr>
                           <td class='table-td'>Quiz 3 - What is the difference between null and undefined in JavaScript?</td>
                           <td class='table-td'>#2 JavaScript Tips and Tricks - JavaScript Job Interview Questions.</td>
                           <td class='table-td flex gap-x-2 justify-center'>
                              <svg
                                 fill='none'
                                 viewBox='0 0 24 24'
